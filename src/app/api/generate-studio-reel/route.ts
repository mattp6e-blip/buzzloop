...
Pacing: punch. pause. punch. No filler.`,
  ...
  const quoteDuration = reviewContext ? 7 : 0
...
Return ONLY valid JSON — no markdown, no explanation:
{
  ...
  "script": {
    ...
    "slides": [
      ...
      ${reviewContext ? `{ "type": "quote", "duration": 7, "content": { "quote": "Verbatim excerpt from the most relevant review", "author": "Reviewer name or null", "highlightWords": ["word1"] } },` : ''}
